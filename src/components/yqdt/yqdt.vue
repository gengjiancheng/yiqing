<template>
  <div>
    ...
    <div>
      <diagram title="全国 新增确诊/疑似 趋势图" :data="dataList"></diagram>
    </div>
    <div>
      <diagram title="全国 累计确诊/疑似 趋势图" :data="dataList2"></diagram>
    </div>
    <div>
      <diagram title="全国 累计治愈/死亡 趋势图" :data="dataList3"></diagram>
    </div>
    <div>
      <mytable></mytable>
    </div>
...
export default {
  ...
  data() {
    return {
      //   dataList: [
      //     // { til: "新增确认", list: [1, 2, 3, 4] },
      //     // { til: "新增疑似", list: [5, 6, 4, 8] }
      //   ]
    };
  },
  created() {
  ...
  computed: {
    dataList() {
      ...
      return [
        { til: "新增确认", list: sureList.reverse(),color:'#e83132' },
        { til: "新增疑似", list: notSureList.reverse(),color:'#ec9217' }
      ];
    },
    dataList2() {
      let history = this.$store.state.china_data.historylist || [];
      ...
      return [
        { til: "确诊", list: sureList,color:'#e83132' },
        { til: "疑似", list: notSureList,color:'#ec9217' }
      ];
    },
    dataList3() {
      let history = this.$store.state.china_data.historylist || [];
      ...
      return [
        { til: "治愈", list: sureList,color:'#10aeb5' },
        { til: "死亡", list: notSureList,color:'#444' }
      ];
    }
  },
  components: {
